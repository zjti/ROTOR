...
test3("Injects the metadata object into an asynchronous handler", async () => {
  const ttl = 3600;
  ...
  const myHandler = async () => {
    const asyncTask = new Promise((resolve4) => {
...
test3("Injects the metadata object into a synchronous handler", async () => {
  const originalResponse = {
    body: ":thumbsup:",
    statusCode: 200
  };
...
test3("Injects the metadata object for non-200 responses", async () => {
  const originalResponse = {
    body: ":thumbsdown:",
    statusCode: 404
  };
...
test3("Returns a 405 error for requests using the POST method", async () => {
  const originalResponse = {
    body: ":thumbsup:",
    statusCode: 200
  };
...
test3("Returns a 405 error for requests using the PUT method", async () => {
  const originalResponse = {
    body: ":thumbsup:",
    statusCode: 200
  };
...
test3("Returns a 405 error for requests using the DELETE method", async () => {
  const originalResponse = {
    body: ":thumbsup:",
    statusCode: 200
  };
...
test3("Returns a 405 error for requests using the PATCH method", async () => {
  const originalResponse = {
    body: ":thumbsup:",
    statusCode: 200
  };
...
test3("Preserves errors thrown inside the wrapped handler", async () => {
...
test3("Does not pass query parameters to the wrapped handler", async () => {
  const originalResponse = {
    body: ":thumbsup:",
    statusCode: 200
  };
