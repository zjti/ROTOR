...
test3("Local Dev", () => {
  ...
  globalExpect(logs.length).toBe(1);
  import_node_process.default.env.NETLIFY_DEV = "true";
  systemLogger.log("hello!");
  globalExpect(logs.length).toBe(1);
  import_node_process.default.env.NETLIFY_ENABLE_SYSTEM_LOGGING = "true";
  systemLogger.log("hello!");
  globalExpect(logs.length).toBe(2);
  delete import_node_process.default.env.NETLIFY_DEV;
  delete import_node_process.default.env.NETLIFY_ENABLE_SYSTEM_LOGGING;
  console.log = originalLog;
});
